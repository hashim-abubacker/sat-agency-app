...
CREATE TABLE IF NOT EXISTS agency_settings (
  ...
  agency_name TEXT NOT NULL DEFAULT 'Elevate Your Brand (EYB) Agency',
...
SELECT 'Elevate Your Brand (EYB) Agency', 'INR', 'https://drive.google.com/drive/folders/sample-root'
